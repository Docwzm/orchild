<template>
    <div class="protocol-wrap">
        <p>欢迎访问安心签平台！对于您的隐私，我们绝对尊重并予以保护，本隐私声明将告诉您，安心签平台（所涉域名为：www.anxinsign.com）收集资料与运用的方式以及我们的隐私保护政策。本站的隐私声明正在不断改进中，随着我站服务范围的扩大，我们会随时更新我们的隐私声明。</p>
        <p>在同意安心签平台服务协议（以下简称“协议”）之时，您已经同意我们按照本隐私声明来使用和披露您的个人信息。本隐私声明的全部条款属于协议的一部份。</p>
        <p class='protocol-subtitle'>未成年人的特别注意事项</p>
        <p>如果您未满18周岁，您无权使用本公司服务，因此我们希望您不要向我们提供任何个人信息。</p>
        <p class='protocol-subtitle'>数字证书、用户名和密码</p>
        ...
        <p class='protocol-subtitle'>注册信息</p>
        ...
        <p class='protocol-subtitle'>银行账号</p>
        <p>我们的一些服务需要付费，我们会合理获取您的银行账号信息。</p>
        <p class='protocol-subtitle'>您的用户行为</p>
        <p>为了提供并优化您需要的服务，我们会根据合理性、必要性原则收集您使用服务的相关信息，这类信息包括：在您使用安心签服务访问网页时，自动接收并记录您的浏览器和计算机上的信息，包括您的IP地址、浏览器的类型、访问日期和时间、软硬件特征信息及您需求的网页记录等数据；如您下载或使用安心签客户端软件，或访问移动网页使用安心签服务时，我们可能会读取与您位置和移动设备相关的信息，包括设备型号、设备识别码 、操作系统、分辨率、电信运营商等。</p>
        ...
        <p class='protocol-subtitle'>Cookie的使用</p>
        ...
        <p class='protocol-subtitle'>信息的披露和使用</p>
        ...
        <p class='protocol-subtitle'>保密条款</p>
...
<script lang="ts" src="./ProtocolPrivacy.ts"></script>

<style lang="scss" src="./ProtocolPrivacy.scss" ></style>
